		...
		<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
			...
			<div className="text-center space-y-4">
				...
				<p className="text-fluid-base text-[var(--color-text-light)] max-w-2xl mx-auto">
					A customizable and theme-responsive status badge component with multiple
					variants and professional styling options. Switch between light and dark mode to
					see the theme transitions.
				</p>
			</div>
			...
			<section className="space-y-6">
				<div className="space-y-2">
					...
					<p className="text-fluid-sm text-[var(--color-text-light)]">
						Choose from 7 different professional style presets for any use case
					</p>
				</div>
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					{/* Default Style */}
					<div className="p-6 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)] space-y-4">
						<div>
							<h3 className="text-fluid-lg font-medium text-[var(--color-text)] mb-1">
								Default
							</h3>
							<p className="text-fluid-sm text-[var(--color-text-light)]">
						...
						<StatusBadge text="Live Project" variant="success" customStyle="default" />
					</div>
					...
					<div className="p-6 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)] space-y-4">
						<div>
							...
							<p className="text-fluid-sm text-[var(--color-text-light)]">
								Clean with soft shadow
							</p>
						</div>
						<StatusBadge text="Live Project" variant="success" customStyle="subtle" />
					</div>
					...
					<div className="p-6 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)] space-y-4">
						...
						<StatusBadge text="Live Project" variant="success" customStyle="glass" />
					</div>
					...
					<div className="p-6 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)] space-y-4">
						...
						<StatusBadge text="Featured" variant="success" customStyle="bold" />
					</div>
					...
					<div className="p-6 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)] space-y-4">
						...
						<StatusBadge text="Live" variant="success" customStyle="minimal" />
					</div>
					...
					<div className="p-6 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)] space-y-4">
						<div>
							...
							<p className="text-fluid-sm text-[var(--color-text-light)]">
								Multi-layer pulse with gradient text
							</p>
						</div>
						<StatusBadge text="Premium Project" variant="success" customStyle="premium" />
					</div>
					...
					<div className="p-6 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)] space-y-4">
						...
						<StatusBadge text="Live Project" variant="success" customStyle="corporate" />
					</div>
				</div>
			</section>
			...
			<section className="space-y-6">
				<div className="space-y-2">
					...
					<p className="text-fluid-sm text-[var(--color-text-light)]">
						Perfect for availability status, completed tasks, or positive confirmations
					</p>
				</div>
				<div className="flex flex-wrap gap-4 p-8 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)]">
					...
					/>
					<StatusBadge text="Active" variant="success" customStyle="bold" />
				</div>
			</section>
			...
			<section className="space-y-6">
				<div className="space-y-2">
					...
					<p className="text-fluid-sm text-[var(--color-text-light)]">
						Ideal for informational messages, response times, or neutral announcements
					</p>
				</div>
				<div className="flex flex-wrap gap-4 p-8 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)]">
					<StatusBadge
					...
					/>
					<StatusBadge text="New update" variant="info" customStyle="glass" />
					<StatusBadge
						text="Beta"
						variant="info"
						showPulse={false}
			...
			<section className="space-y-6">
				<div className="space-y-2">
					...
					<p className="text-fluid-sm text-[var(--color-text-light)]">
						Great for attention-grabbing messages, limited availability, or cautionary
						notes
					</p>
				</div>
				<div className="flex flex-wrap gap-4 p-8 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)]">
			...
			<section className="space-y-6">
				<div className="space-y-2">
					...
					<p className="text-fluid-sm text-[var(--color-text-light)]">
						Elegant purple styling for exclusive features, VIP content, or premium
						offerings
					</p>
				</div>
				<div className="flex flex-wrap gap-4 p-8 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)]">
			...
			<section className="space-y-6">
				<div className="space-y-2">
					...
					<p className="text-fluid-sm text-[var(--color-text-light)]">
						Uses your site's theme colors, perfect for section badges and branded elements
					</p>
				</div>
				<div className="flex flex-wrap gap-4 p-8 bg-[var(--color-secondary)] rounded-2xl border border-[var(--color-border)]">
					<StatusBadge
...
/>`}</code>
					...
					<div className="p-6 bg-[var(--color-secondary)] rounded-xl border border-[var(--color-border)]">
						<p className="text-fluid-sm text-[var(--color-text-light)] mb-3">
							Glass style with custom variant:
						</p>
						<pre className="text-fluid-sm text-[var(--color-text)] overflow-x-auto">
							<code>{`<StatusBadge
  text="Live Project"
...
/>`}</code>
					...
					<div className="p-6 bg-[var(--color-secondary)] rounded-xl border border-[var(--color-border)]">
						<p className="text-fluid-sm text-[var(--color-text-light)] mb-3">
							Minimal style with custom class:
						</p>
						<pre className="text-fluid-sm text-[var(--color-text)] overflow-x-auto">
							<code>{`<StatusBadge
  text="Live"
...
/>`}</code>
			...
			<section className="space-y-6">
				<div className="space-y-2">
					<h2 className="text-fluid-2xl font-medium text-[var(--color-text)]">Props</h2>
					<p className="text-fluid-sm text-[var(--color-text-light)]">
					...
					<table className="w-full text-left border-collapse">
						...
						<tbody className="text-fluid-sm">
							...
							<tr className="border-b border-[var(--color-border)]">
								...
								<td className="p-4 text-[var(--color-text-light)]">"success"</td>
								<td className="p-4 text-[var(--color-text-light)]">
									Visual style variant
								</td>
							</tr>
							<tr className="border-b border-[var(--color-border)]">
								<td className="p-4 font-mono text-gray-400">customStyle</td>
								<td className="p-4 text-[var(--color-text-light)]">
									"default" | "subtle" | "glass" | "bold" | "minimal" | "premium" |
									"corporate"
								</td>
								<td className="p-4 text-[var(--color-text-light)]">"default"</td>
								<td className="p-4 text-[var(--color-text-light)]">
									Visual style preset
								</td>
							</tr>
							...
							<tr className="border-b border-[var(--color-border)]">
								...
								<td className="p-4 text-[var(--color-text-light)]">React.ReactNode</td>
								<td className="p-4 text-[var(--color-text-light)]">undefined</td>
								<td className="p-4 text-[var(--color-text-light)]">
