...
> = {
	...
	strong: ({children, ...props}: any) => (
		<strong className="font-semibold text-[var(--color-text)] inline" {...props}>
			{children}
		</strong>
	),
	...
	tr: ({children, ...props}: any) => (
		<tr className="border-b border-[var(--color-border)] last:border-b-0" {...props}>
			{children}
		</tr>
	),
	...
	hr: (props: any) => (
		<hr className="my-[var(--space-l)] border-[var(--color-border)]" {...props} />
	),
