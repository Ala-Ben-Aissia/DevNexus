...
export default function BlogPage({loaderData: posts}: Route.ComponentProps) {
	...
	const filteredPosts = posts.filter(post => {
		// Category filter
		const categoryMatch = selectedCategory === 'All' || selectedCategory === 'Tech'
			...
			<div className="w-full overflow-x-hidden space-y-20 lg:space-y-32">
				...
				<div className="w-full text-center space-y-12 lg:space-y-16 relative px-4 sm:px-6">
					...
					<p className="text-fluid-base text-[var(--color-text-light)] max-w-2xl mx-auto leading-relaxed font-normal">
						Deep dives into modern web development, design patterns, and the latest
						technologies shaping the future of digital experiences.
					</p>
				</div>
					...
					<div className="bg-gradient-to-br from-[var(--color-secondary)] to-[var(--color-tertiary)] rounded-3xl border border-[var(--color-border)] p-16 lg:p-20 text-center hover-lift relative overflow-hidden max-w-2xl">
						...
						<div className="relative z-10">
							...
							<p className="text-fluid-base text-[var(--color-text-light)] leading-relaxed font-normal">
								I'm working on some exciting content. Check back soon for new articles and
								insights!
							</p>
						</div>
					</div>
	...
	return (
		<div className="space-y-12 lg:space-y-16">
			...
			<div className="text-center space-y-6 relative">
				...
				<div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-4">
					<div className="text-center">
						...
						<div className="text-fluid-sm text-[var(--color-text-light)]">Articles</div>
					</div>
					...
					<div className="bg-gradient-to-br from-[var(--color-secondary)] to-[var(--color-tertiary)] rounded-3xl border border-[var(--color-border)] p-12 lg:p-16 text-center hover-lift relative overflow-hidden max-w-2xl mx-auto">
						...
						<div className="relative z-10">
							...
							<p className="text-fluid-base text-[var(--color-text-light)] leading-relaxed font-normal mb-6">
								No articles match your search for "<strong>{searchQuery}</strong>". Try
          ...
          ></div> */}
					...
					<div className="relative z-10">
						<StatusBadge text="Stay Connected - Join the community" variant="info" />
						...
						<p className="text-fluid-base text-[var(--color-text-light)] mb-8 lg:mb-12 max-w-2xl mx-auto leading-relaxed font-normal">
							Join a growing community of developers who rely on these insights to stay
							ahead. Get exclusive tips, early access to new articles, and
