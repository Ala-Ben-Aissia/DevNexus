  ...
  return (
    <div className="space-y-12 lg:space-y-16">
      ...
      <div className="text-center space-y-6 animate-fade-in-up relative">
        {/* Availability badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-full text-green-700 dark:text-green-300 text-fluid-sm font-medium mb-4">
