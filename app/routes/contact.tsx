		...
		<div className="space-y-12 lg:space-y-16">
			...
			<div className="text-center space-y-6 relative">
				...
				<p className="text-fluid-base text-[var(--color-text-light)] max-w-2xl mx-auto leading-relaxed font-normal">
					Ready to turn your vision into reality? I'm here to help you build something
					extraordinary. Let's start the conversation.
				</p>
						...
						<div className="relative z-10 space-y-8">
							<div>
								...
								<p className="text-fluid-base text-[var(--color-text-light)] leading-relaxed font-normal">
									Ready to discuss your project? I'm here to help you build something
									amazing. Let's explore the possibilities together.
								</p>
							</div>
