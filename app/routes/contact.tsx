            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="pt-6 border-t border-[var(--color-border)]">
                <p className="text-fluid-sm text-[var(--color-text-light)] leading-relaxed font-normal">
                  ...
                  <a
                    href="#"
                    className="text-[var(--color-text)] hover:text-[var(--color-text)] underline decoration-[var(--color-accent)] underline-offset-4 transition-colors duration-300 font-medium"
                  >
                    LinkedIn
                  </a>{" "}
                  or{" "}
